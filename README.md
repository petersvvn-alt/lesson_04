...
2. Отмонтировfk диск, который монтировал в предыдущем ДЗ
...
9. Добавляю в volume group третий раздел диска /dev/sdb и  расширяю logical volume mysql на весь доступный объем volume group
